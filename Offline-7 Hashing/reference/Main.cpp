    ...
    for (long long n : size)
    {
        ...
        for (long long j = 0; j < 3; j++)
        {
            if (j == 0)
                ...
                file << "|" << setw(34) << right << "| Double Hashing    | ";
            else
                file << "|" << setw(34) << right << "| Custom Probing    | ";
            ...
            for (long long k = 0; k < 2; k++)
            {
                ...
                {
                    if (m == 0)
                        file << defaultfloat << setw(5) << setprecision(5) << right << report[i][j][k][m] << "  ";
                    if (m == 1)
                        file << fixed << setw(2) << setprecision(3) << " " << report[i][j][k][m] << "  ";
                }
